...
State.prototype.clone = function(node, parentNode) {
    ...
    if (traces) {
        traces.push(this.currentTrace.slice());
    }
...
State.prototype.fail = function(comment) {
    if (this.currentTrace) {
        this.currentTrace.isEndTrace = 'fail';
    }
    return false;
};
...
State.prototype.success = function() {
    if (this.currentTrace) {
        this.currentTrace.isEndTrace = 'success';
    }
};
...
function match(state, node) {
    function fork(parentNode, childNode, resetMatches) {
        ...
        if (parentNode.type === Node.REPEAT) {
            forkedState.recordNode(parentNode);
        }
